...
def run_script(earth_model, seismic_model,
    ...
    axarr[0][0].axhline(y=int(args.time*seismic_data.shape[0]), lw=3,
                        color='g')
    ...
    axarr[1][0].plot(seismic_data[int(args.time*seismic_data.shape[0]),:,
                                  0, 0], 'g', lw = 3)
    ...
    axarr[0][1].axhline(y=int(args.time*seismic_data.shape[0]),
                        lw=3, color='g')
    ...
    axarr[0][1].fill_betweenx(x, args.theta + gain2 * trace2,
                              ...
                              color = 'k', alpha = 0.5)
    # line plot
    data2 = seismic_data[int(args.time*seismic_data.shape[0]), 0, :, 0]
    ...
    axarr[0][2].axhline(y=args.time * seismic_data.shape[0],
                        lw=3, color='g')
    ...
    axarr[0][2].fill_betweenx(x, f + gain3 * trace3, f, 
                              ...
                              color = 'k', alpha = 0.5)
    #line plot
    data3 = seismic_data[args.time * seismic_data.shape[0],
                         0, 0, :]
